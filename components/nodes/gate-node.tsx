...
import { Shield, Trash2, Lock, ChevronDown, ChevronUp, FolderOpen } from "lucide-react"
  ...
  if (isCollapsed) {
    return (
      <div className="relative group">
        ...
        <div className={`bg-gradient-to-r ${getGateColor()} rounded-xl shadow-lg min-w-[100px] overflow-hidden hover:shadow-xl transition-all duration-200`}>
          <div className="px-3 py-2 flex items-center gap-2">
            ...
            <div className="flex-1 text-center">
              <div className="text-xs font-semibold text-white truncate max-w-[80px]">{gateName}</div>
              {data.group && (
